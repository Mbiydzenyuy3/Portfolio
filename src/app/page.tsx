          ...
          <div className='w-full md:w-2/3'>
            <div className='flex items-center gap-3 mb-6'>
              ...
              <span className='text-xs font-medium text-green-700 dark:text-green-400'>
                Available to collaborate and work together
              </span>
            </div>
            ...
            <p className='text-gray-600 dark:text-gray-300 mb-8 max-w-2xl leading-relaxed'>
              Junior Full-stack Developer. I am passionate about the frontend
              development, creating user-friendly web and mobile apps that
              enhance the digital experience for clients.
            </p>
